import {find, update, remove, create}  from '../models/question-model'
...
const removeQuestion = async(ctx, next)=> {
    let param;
    if(ctx.method === 'GET') {
        param = ctx.request.query
    } else {
...
module.exports = {getQuestions, updateQuestion, createQuestion, removeQuestion}
