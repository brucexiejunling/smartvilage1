...
(function(){
    ...
    function createPreviewVideo(url){
        ...
        if(/^<iframe/.test(url)){
            ...
            $G("preview").innerHTML = '<div class="previewMsg"><span>'+lang.urlError+'</span></div>'+
                '<embed class="edui-upload-video  vjs-default-skin video-js" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"' +
                ' src="' + conUrl + '"' +
                ' width="' + 420  + '"' +
                ' height="' + 280  + '"' +
        ...
        //
        //var r = /\.([a-zA-Z0-9]+)$/;
        //var macthes = r.exec(conUrl);
        //var ext = ''
        //if(macthes && macthes.length > 1) {
        //   ext = macthes[1]
        //}
        //
        //$G("preview").innerHTML = '<div class="previewMsg" style="background: transparent!important;"><span>请确保视频链接正确可用, <br>点击下面的播放按钮可以预览视频</span></div>'+
        //        '<p><video class="edui-upload-video  vjs-default-skin video-js" controls="" preload="none" width="420" height="280" src="'
        //        + conUrl + '"><source src="' + conUrl + '" type="video/' + ext + '"/></video></p>';
